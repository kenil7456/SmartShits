...
<body>
    <div class="login-page-container">
        <div class="login-logo-container">
            ...
            <h1 class="login-page-title">Login Failed!</h1>
            <h2 class="login-page-slogan">Smart Shifts</h2>
            <h2 class="login-page-slogan">Your Workforce, Our Expertise</h2>
        </div>
        <div class="login-form-container">
            <h2>Welcome Back!</h2>
            <form name="f1" action="authentication.php" class="login-form" method="post" onsubmit="return validation()">
    ...
    <script>  
            ...
            {  
                ...
                if(id.length=="" && ps.length=="") {  
                    ...
                    console.log("User Name and Password fields are empty");
